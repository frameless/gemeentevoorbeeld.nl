...
import '@frameless/nlds-templates-components-css/toptasklink/index.scss';
  ...
  (
    ...
    <a
      ...
      className={clsx(
        ...
        'example-link--html-a',
        {
          'example-link--box-content': boxContent,
          'example-link--external': external,
          'example-link--placeholder': placeholder,
        },
        className,
      )}
